...
const Login = () => {
  ...
  return (
    <div className="min-h-screen bg-[#07090e] text-zinc-100 flex items-center justify-center px-4 relative overflow-hidden select-none font-sans">
      ...
      <div className="absolute top-[15%] right-[15%] w-[300px] h-[300px] rounded-full bg-indigo-600/10 blur-[100px] pointer-events-none" />
      <div className="absolute bottom-[15%] left-[15%] w-[250px] h-[250px] rounded-full bg-purple-600/5 blur-[90px] pointer-events-none" />
      ...
      >
        ...
        <div className="flex flex-col items-center text-center gap-2 mb-8">
          ...
          <h1 className="text-2xl font-black text-white tracking-tight">Access Grind Console</h1>
          <p className="text-zinc-400 text-xs font-medium max-w-xs leading-relaxed">
            Enter credentials below to resume your daily habits, roadmaps, and milestones.
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="space-y-1.5">
            <label className="text-[10px] text-zinc-400 font-bold uppercase tracking-wider block">Password Key</label>
            <div className="glass-input rounded-xl px-4 py-3 flex items-center gap-3 transition">
        ...
        <div className="text-center mt-6 text-xs text-zinc-400 font-medium">
          ...
          <Link to="/register" className="text-blue-400 hover:text-blue-300 font-bold transition underline underline-offset-4">
