...
const Register = () => {
  ...
  return (
    <div className="min-h-screen bg-zinc-950 flex items-center justify-center px-4 relative overflow-hidden select-none font-sans">
      ...
      <div className="absolute bottom-[10%] left-[10%] w-[100px] h-[100px] rounded-full bg-indigo-500/5 blur-[50px] pointer-events-none"></div>
      ...
      >
        ...
        <div className="flex flex-col items-center text-center gap-2 mb-8">
          ...
          <h1 className="text-2xl font-black text-white tracking-tight mt-3">Register New Account</h1>
          <p className="text-zinc-500 text-xs font-semibold max-w-xs leading-relaxed">
            Create an account below to unlock your gamified study roadmaps console.
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="space-y-1.5">
            <label className="text-[10px] text-zinc-400 font-bold uppercase tracking-wider">Account Name</label>
          ...
          <div className="space-y-1.5">
            <label className="text-[10px] text-zinc-400 font-bold uppercase tracking-wider">Password Secret</label>
            <div className="bg-zinc-950 border border-zinc-900 focus-within:border-zinc-800 rounded-xl px-4 py-3 flex items-center gap-2.5 transition">
