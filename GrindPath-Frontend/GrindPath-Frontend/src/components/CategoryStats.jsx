  ...
  if (active && payload && payload.length) {
    return (
      <div className="bg-zinc-900 border border-zinc-800 px-3.5 py-2 rounded-xl shadow-xl">
        <span className="text-zinc-200 text-xs font-bold">{payload[0].name}: {payload[0].value} Goals</span>
      </div>
    )
  }
  return null
...
const CategoryStats = () => {
  ...
  return (
    <div className="glass-card rounded-3xl p-6 border-zinc-800 bg-zinc-900/30 flex flex-col justify-between h-full">
      <div className="flex items-center gap-2 pb-4 border-b border-zinc-900/80 mb-4">
